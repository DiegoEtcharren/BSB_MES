...
function ShippedOrdersChart({ data = [], isLoading = false }) {
  ...
  if (!data || data.length === 0) {
    return (
      <div className="h-[250px] flex flex-col items-center justify-center text-center p-4 bg-gray-50/30 border border-dashed border-gray-200 rounded-xl">
  ...
  return (
    <div className="flex flex-col h-full min-h-[250px]">
      ...
      {selectedData && (
        <div className="flex flex-wrap items-center gap-3 bg-gray-50 border border-gray-100 rounded-xl p-2 text-xs mb-3 transition-all duration-300">
      ...
      <div className="flex-1 flex gap-4 min-h-0 relative select-none">
        {/* Y-Axis Labels */}
        <div className="flex flex-col justify-between text-right text-[10px] text-gray-400 font-bold w-12 pb-6 pr-2">
          {yTicks.map((tick, idx) => (
        ...
        <div className="flex-1 flex flex-col min-h-0 relative">
          ...
          {/* Bars Container */}
          <div className="flex-1 flex items-end justify-around relative z-10 pb-6 min-h-0 gap-1.5">
            {data.map((item) => {
...
export default function EngDashboard() {
  ...
  return (
    <div className="bg-white rounded-xl border border-border-subtle shadow-sm overflow-hidden flex flex-col flex-1 min-h-0">
      <div className="flex flex-col flex-1 min-h-0 space-y-3 overflow-y-auto p-3 md:p-4">
        {/* KPIs Row */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          >
            ...
            <Spin spinning={isLoading}>
              <div>
                <Title level={4} style={{ margin: 0, fontSize: "15px", fontWeight: 700 }} className="leading-tight">
                  {kpis?.active_orders?.total_value !== undefined
                    ...
                    : "$0"}{" "}
                  <span className="text-[10px] font-normal text-gray-400">backlog</span>
                </Title>
              </div>
              <div className="flex items-center text-xs mt-0.5">
                <Text type="secondary" className="text-gray-400 text-[10px]">
          ...
          >
            ...
            <div className="flex items-center text-xs mt-0.5">
              ...
              <span className="text-red-500 font-medium mr-1 text-[10px]">+12.5%</span>
              <Text type="secondary" className="text-[10px]">vs last week</Text>
            </div>
          </Card>
          ...
          >
            ...
            <div className="flex items-center text-xs mt-0.5">
              ...
              <span className="text-gray-500 font-medium mr-1 text-[10px]">0.0%</span>
              <Text type="secondary" className="text-[10px]">vs last week</Text>
            </div>
          </Card>
          ...
          >
            ...
            <div className="flex items-center text-xs mt-0.5">
              ...
              <span className="text-green-500 font-medium mr-1 text-[10px]">-5.2%</span>
              <Text type="secondary" className="text-[10px]">vs last week</Text>
            </div>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 flex-1 mt-2">
          <div className="lg:col-span-2">
            <Card
              className="shadow-sm border-gray-200 h-full min-h-[300px] bg-white"
                    ...
                    <div className="space-y-3">
                      {kpis.past_due_orders.map((order) => {
                        ...
                        return (
                          <div
                            key={order.id}
                            className="p-2.5 bg-red-50/30 border border-red-100 rounded-xl hover:bg-red-50/50 transition-all duration-200 flex flex-col gap-1.5 relative overflow-hidden animate-fade-in"
                          >
                            {/* Accent line on left */}
                            ...
                            <div className="flex justify-between items-center pl-1">
                              ...
                              <span className="bg-red-100 text-red-800 text-[9px] font-extrabold px-1.5 py-0.5 rounded-full uppercase tracking-wider shrink-0">
                                {daysOverdue}{" "}
                                {daysOverdue === 1 ? "day" : "days"} overdue
                              </span>
                            </div>

                            <div className="flex items-center justify-between text-xs text-gray-500 pl-1 mt-0.5">
                            ...
                            <div className="flex items-center justify-between border-t border-red-100/50 pt-1.5 mt-0.5 pl-1">
